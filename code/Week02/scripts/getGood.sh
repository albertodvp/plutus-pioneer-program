...
cardano-cli transaction build \
            ...
            --tx-in-redeemer-file "assets/homework2ValidRedeemer.json" \
            --tx-in-collateral "$2" \
            ...
            --out-file "assets/homework2getGood.txbody"

# Sign the transaction
cardano-cli transaction sign \
            --testnet-magic 2 \
            --tx-body-file "assets/homework2getGood.txbody" \
            --signing-key-file "$key.skey" \
            --out-file "assets/homework2getGood.tx"

# # This will burn collateral
cardano-cli transaction submit \
            --testnet-magic 2 \
            --tx-file  "assets/homework2getGood.tx"

# Get txid
echo $(cardano-cli transaction txid --tx-file "assets/homework2getGood.tx")
